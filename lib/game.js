...
class Game {
  ...
  run() {
    ...
    let spikeCollisions = new SpikeCollisions(self.players, self.flags, self.spikes)
    ...
    requestAnimationFrame(function gameLoop() {
      ...
      self.spikes.forEach(spike => spike.move(game_counter))

      ballCollisions.testCollisions()
      spikeCollisions.spikeCollision()
